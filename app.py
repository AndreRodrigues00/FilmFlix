...
def home():
    ...
    return render_template('home.html', data=json_data, title = 'Home')
...
def addfilms():
    if request.method == 'POST':
        ...
        cursor.execute('INSERT INTO films (filmID, title, yearreleased, rating, duration, genre) VALUES (?,?,?,?,?,?)',(filmID, title, yearreleased, rating, duration, genre))
        conn.commit()
        conn.close()
